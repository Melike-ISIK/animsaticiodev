...
class _CreateTodoPageState extends State<CreateTodoPage> {
  ...
  void fetch() {
    ...
    if (_id == null) {
      ...
      _contentController.text = editedData['ICERIK'];
    }
  }

  void _save() {
    if (_contentController.text.isEmpty) {
      showInSnackBar('ICERIK BOS OLAMAZ');
      return;
    }
    if (_id == null) {
  ...
  Widget buildAppBar() {
    return AppBar(
      title: Text(
        _id == null ? 'ANIMSATICI URET' : 'ANIMSATICIYI GUNCELLE',
        style: TextStyle(
  ...
  Widget buildTextField() {
    return Card(
      ...
      child: TextField(
        ...
        onChanged: (value) {
          setState(() {
            editedData['ICERIK'] = value;
          });
        },
        decoration: InputDecoration(
          border: InputBorder.none,
          contentPadding: const EdgeInsets.fromLTRB(20, 10, 10, 10),
          hintText: 'ANIMSATICI URET...',
        ),
      ),
    );
  }
